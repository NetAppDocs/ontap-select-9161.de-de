...
link:reference_lic_ontap_features.html#ontap-features-automatically-enabled-by-default["Erfahren Sie mehr über die standardmäßig aktivierten ONTAP -Funktionen"] link:concept_lic_evaluation.html["Erfahren Sie mehr über die ONTAP Select Lizenzoptionen"]
