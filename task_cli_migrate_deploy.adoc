...
== Installieren Sie eine neue Instanz der virtuellen Deploy-Maschine
...
.Schritte
. Verwenden Sie in einer Befehlsshell auf Ihrer lokalen Arbeitsstation das SFTP-Dienstprogramm, um die Sicherungsdatei auf die virtuelle Deploy-Maschine hochzuladen.
+
Beispiel
