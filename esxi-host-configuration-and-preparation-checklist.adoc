...
. Machen Sie sich mit den erforderlichen vCenter-Rechten vertraut. Sehen link:reference_plan_ots_vcenter.html["VMware vCenter-Server"] für weitere Informationen.
