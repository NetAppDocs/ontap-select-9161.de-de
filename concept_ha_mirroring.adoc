...
Ein Cluster mit zwei Knoten und einem Mediator kann zwei Rechenzentren umfassen. Weitere Informationen finden Sie im Abschnitt link:reference_plan_best_practices.html#two-node-stretched-ha-metrocluster-sds-best-practices["Best Practices für gestreckte HA mit zwei Knoten (MetroCluster SDS)"] .
...
* ONTAP Select des Schreibpfads* image:DDHA_04.jpg["ONTAP Select “"]
